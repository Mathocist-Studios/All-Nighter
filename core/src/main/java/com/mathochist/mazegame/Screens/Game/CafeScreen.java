...
public class CafeScreen extends BaseGameScreen {

    private double timeSinceLastSprintPenalty = 0;
    private double timeSinceLastPauseToggle = 0;

    public CafeScreen(Main game) {
        super(game);
        super.setWorld(new GameWorld(game, this, Gdx.files.internal("maps/cafe.json"), super.getScreenBatch()));
    ...
    public CafeScreen(Main game, Float spawnX, Float spawnY) {
        super(game);
        super.setWorld(new GameWorld(game, this, Gdx.files.internal("maps/cafe.json"), super.getScreenBatch()));
