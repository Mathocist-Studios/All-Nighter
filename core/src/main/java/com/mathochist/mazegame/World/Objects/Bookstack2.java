...
public class Bookstack2 extends MapEntity {

    public Bookstack2(Main game, SpriteBatch batch, TextureAtlas atlas, Integer TileX, Integer TileY, Integer Width, Integer Height, Boolean collidable) {
        super(game, batch, atlas, "book_stack2", TileX, TileY, Width, Height, collidable);
    }
